...
# Therapy sessions - both manual and videocall routers
from app.therapy_sessions.router import manual_router as therapy_manual_router
from app.therapy_sessions.router import videocall_router as therapy_videocall_router

# Optional videocallsupports
try:
...
try:
    ...
    patient_homework_available = True
except ImportError:
    patient_homework_available = False
...
def create_app() -> FastAPI:
    ...
    # Therapy sessions - both manual logging and videocall
    app.include_router(therapy_manual_router)
    app.include_router(therapy_videocall_router)
