...
def session_summarizer_node(state: GeneralSupportState) -> Dict[str, Any]:
    """
...
def _build_prompt(
    *,
    ...
    return f"""
You are extracting relevant context from a therapy session transcript for an OCD support chatbot.
...
- session_context_summary (empty string if nothing relevant)
""".strip()
